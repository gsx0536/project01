package com.tieda.alarm.service.testScheme;
 ...
 * @since 2019-12-11
 */
public interface ITestSchemeService extends IService<TestScheme> {
    ...
    TestScheme getTestSchemeById(Long id);
         ...
         * @param obj   对象实体
         */
        void addTestScheme(HttpServletRequest request,Map param);
